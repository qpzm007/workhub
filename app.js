...
try {
    ...
    function openFileDetailModal(fileId) {
        try {
            ...
            const displayFolderName = relPath.includes('/') ? relPath.substring(0, relPath.lastIndexOf('/')) : file.folder;
            const cleanDisplayFolderName = displayFolderName.includes('_') ? displayFolderName.split('_').slice(1).join('_') : displayFolderName;
